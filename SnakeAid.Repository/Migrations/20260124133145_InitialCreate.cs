        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rating = table.Column<float>(type: "numeric(3,2)", nullable: false, defaultValue: 0f),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpertProfiles_AspNetUsers_Id",
                        column: x => x.Id,
                        principalSchema: "SnakeAidDb",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rating = table.Column<float>(type: "numeric(3,2)", nullable: false, defaultValue: 0f),
                    RatingCount = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    EmergencyContacts = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberProfiles_AspNetUsers_Id",
                        column: x => x.Id,
                        principalSchema: "SnakeAidDb",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RescuerProfiles_AspNetUsers_Id",
                        column: x => x.Id,
                        principalSchema: "SnakeAidDb",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpertSpecializations", x => new { x.ExpertProfileId, x.SpecializationId });
                    table.ForeignKey(
                        name: "FK_ExpertSpecializations_ExpertProfiles_ExpertProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RescuerProfiles_Rating",
                schema: "SnakeAidDb",
                table: "RescuerProfiles",
                column: "Rating");
